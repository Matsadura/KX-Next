...
/**
 * KXStatus::CheckStatus - Checks the application status via remote API
...
/**
 * KXStatus::ReadStatusJson - Parses and processes the status JSON response.
 * Returns: True if the JSON is valid and processed successfully, false otherwise.
 */
